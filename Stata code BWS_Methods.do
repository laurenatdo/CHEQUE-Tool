...
macro drop _all
capture log close
cd "G:\Projects\PhRMA Foundation Research Award - CEA Quality Assessment Tool\7. Data Analysis\Methods"
set more off, perm
*--------------------------------------------------
...
import excel "BWS_1_36 objects METHODS.xlsx", sheet("Sheet1") firstrow
save "BWSExpDesign.dta", replace

*Import your data
import excel "BWSData_Methods.xlsx", sheet("Sheet1") firstrow clear
save "BWSData_Methods.dta", replace
...
*Label statements - optional but highly reccomended
	...
	12 "3. Time Horizon and discounting" ///
	13 "1. Modeling" ///
	14 "2. Modeling" ///
	15 "3. Modeling" ///
	16 "4. Modeling" ///
	17 "5. Modeling" ///
	18 "1. Data inputs and evidence synthesis" ///
	19 "2. Data inputs and evidence synthesis" ///
	20 "3. Data inputs and evidence synthesis" ///
	21 "1. Consequences" ///
	22 "2. Consequences" ///
	23 "1. Utilities (preference measures)" ///
	24 "2. Utilities (preference measures)" ///
	25 "3. Utilities (preference measures)" ///
	26 "1. Costs and resource use" ///
	27 "2. Costs and resource use" ///
	28 "1. Analysis" ///
	29 "2. Analysis" ///
	30 "3. Analysis" ///
	31 "4. Analysis" ///
